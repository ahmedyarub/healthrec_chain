                    ...
                    <div class="card input_text_fields m-t-35">
                        ...
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="col-lg-4 input_field_sections check_align">
                                    <h5>Checkboxes & Radio Buttons</h5>
                                    <div class="input-group">
                                            <span class="input-group-addon">
                                                <label class="custom-control form-control-label custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input form-control">
                                                    <span class="custom-control-indicator cus_control_indicator"></span>
                                                </label>
                                            </span>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="input-group input_top_align">
                                                <span class="input-group-addon">
                                                     <label class="custom-control form-control-label custom-radio">
